    ...
    $.slickQuiz = function(element, options) {
        var plugin = this,
          ...
          defaults = {
            ...
            backButtonText: "Back",
            completeQuizText: "Submit Quiz",
            tryAgainText: "Try Again",
            backToLesson: "Go Back to Knowledge Room",
            continueText: "Continue other Test",
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.tryAgainText && plugin.config.tryAgainText !== '') {
                    $quizResultsCopy.append('<p><a class="button ' + tryAgainClass + '" href="#">' + plugin.config.tryAgainText + '</a><a class="button ' + tryAgainClass + '" href="../../index.html#store">' + plugin.config.continueText + '</a></p>');
                }

                 if (plugin.config.scoreTemplateText && plugin.config.scoreTemplateText !== '') {
                        if (plugin.config.scoreTemplateText = "10%") {
                            $Review.append('<p><strong>System Review:</strong><i style="color:red">Your Performance is Below Average </i><a class="button ' + tryAgainClass + '" href="../knowledge-room">' + plugin.config.backToLesson + '</a></p>');
                        }else  if (plugin.config.scoreTemplateText = "20%") {
                            $Review.append('<p><strong>System Review:</strong><i style="color:red">Your Performance is Below Average </i><a class="button ' + tryAgainClass + '" href="../knowledge-room">' + plugin.config.backToLesson + '</a></p>');
                        }else  if (plugin.config.scoreTemplateText = "30%") {
                            $Review.append('<p><strong>System Review:</strong><i styles="color:red">Your Performance is Below Average </i><a class="button ' + tryAgainClass + '" href="../knowledge-room">' + plugin.config.backToLesson + '</a></p>');
                        }else  if (plugin.config.scoreTemplateTex = "40%") {
                            $Review.append('<p><strong>System Review:</strong><i style="color:red">Your Performance is Below Average </i><a class="button ' + tryAgainClass + '" href="../knowledge-room">' + plugin.config.backToLesson + '</a></p>');
                        }else  if (plugin.config.scoreTemplateText = "50%") {
                            $Review.append('<p><strong>System Review:</strong><i style="color:red">Your Performance is Below Average </i><a class="button' + tryAgainClass + '" href="../knowledge-room">' + plugin.config.backToLesson + '</a></p>');
                        }
                }
                 ...
                 // add retry button to results view, if enabled
               /* if (plugin.config.continueText && plugin.config.continueText !== '') {
                    $quizResultsCopy.append('<a class="button" href="../index.html#store">' + plugin.config.continueText + '</a>');
                }*/
